            ...
            <div className="form-container">
                ...
                <form className="form-login">
                    <div className="input-group">
                        ...
                        <input type="email" name="email" id="username" placeholder="" value={email} onChange={(e)=>setEmail(e.target.value)}/>
                    </div>
                    <div className="input-group">
                    ...
                    <button type='button' className="sign" onClick={submit}>Sign in</button>
                </form>
